...
$_LANG['domainregisternsdelsuccess'] = "名称服务器已成功删除";
...
$_LANG['forwardingtogateway'] = "请稍候，系统会将您重定向至使用所选支付方式完成支付";
...
$_LANG['enomfrregistration']['法国个人']['要求'] = "请提供您的\"出生日期\"、\"出生地城市\"、\"出生地邮政编码\"和\"合法身份证件\"。";
$_LANG['enomfrregistration']['欧盟非法国个人']['姓名'] = "欧盟非法国个人";
$_LANG['enomfrregistration']['欧盟非法国个人']['要求'] = "请提供您的\"出生日期\"和\"合法身份证件\"。";
...
$_LANG['clientAlerts']['servicesRenewingSoon'] = "您有 :numberOfServices 项服务可供续订。";
...
$_LANG['clientHomePanels']['serviceRenewingSoonMsg'] = "您的 :numberOfServices 服务即将续订。请立即续订，以确保安全。";
...
$_LANG['servicesRenew'] = "续订";
$_LANG['renewService']['titlePlural'] = "续订服务";
$_LANG['renewService']['titleSingular'] = "续订服务";
$_LANG['renewService']['titleAltPlural'] = "服务续订";
$_LANG['renewService']['titleAltSingular'] = "服务续订";
$_LANG['renewService']['noServices'] = "您目前没有任何符合续订条件的服务。";
$_LANG['renewService']['showingServices'] = "正在显示 :显示 :totalCount 服务。";
$_LANG['renewService']['renewingIn'] = "在 :days 天后续订";
$_LANG['renewService']['renewalUnavailable'] = "无法续订";
...
$_LANG['renewService']['renewalPeriodLabel'] = "续订周期";
$_LANG['renewService']['renewalPeriod'] = "(:nextDueDate - :nextPayUntilDate) @ :renewalPrice";
$_LANG['renewService']['searchPlaceholder'] = "按名称、域或 ID 搜索";
$_LANG['renewService']['hideShowServices']['hide'] = "隐藏不可更新的项目";
$_LANG['renewService']['hideShowServices']['show'] = "显示不可更新的项目";

$_LANG['renewService']['statusInfo']['notSupported'] = "该产品不支持按需续订。";
$_LANG['renewService']['statusInfo']['nonRecurring'] = "这是一项一次性服务，不使用定期计费。";
$_LANG['renewService']['statusInfo']['outsideRenewal'] = "此服务不在续订期内。";
$_LANG['renewService']['statusInfo']['serviceStatus'] = "此服务是:serviceStatus。续订需要处于活动状态。";
$_LANG['renewService']['statusInfo']['unpaidInvoices'] = "该服务有 :unpaidInvoiceCount 未付账单。";
$_LANG['renewService']['statusInfo']['metricUsage'] = "这是按使用量计费的服务，不支持按需续订。";

$_LANG['renewServiceAddon']['titleAltSingular'] = "插件续订";
$_LANG['renewServiceAddon']['titleAltPlural'] = "插件续订";
...
$_LANG['paymentMethods']['mandateAcceptance'] = "提供您的付款信息并确认此付款，即表示您授权 (A) :companyName 和 Stripe（我们的付款服务提供商）向您的银行发送从您的账户中扣款的指令，以及 (B) 您的银行根据这些指令从您的账户中扣款。作为您权利的一部分，您有权根据与银行签订的协议条款和条件从银行获得退款。退款申请必须在账户扣款之日起 8 周内提出。您可以从银行获得一份声明，其中解释了您的权利。您同意在未来扣款发生前 2 天收到扣款通知";
$_LANG['paymentMethods']['achMandateAcceptance'] = "通过点击'提交付款'，您授权 :companyName 根据 :companyName 的网站和条款，从上述指定的银行账户中扣除您在使用 :companyName 的服务和/或从 :companyName 购买产品时产生的任何欠款，直至本授权被撤销。您可随时修改或取消本授权，但需提前 30 (30) 天通知 :companyName。如果您根据 :companyName 的条款定期使用 :companyName 的服务或购买其他产品，您授权 :companyName 定期从您的银行账户中扣款。不在上述授权定期扣款范围内的付款只有在获得您的授权后才能扣款";
...
$_LANG['paypalCommerce']['payerApprovedPlaceholder'] = "链接账户";
$_LANG['paypalCommerce']['paymentInstructions'] = "要使用 PayPal 完成支付，请选择一个现有的链接 PayPal 帐户或链接一个新帐户";
$_LANG['paypalCommerce']['payerApprovedInstructions'] = "点击以下链接完成 PayPal 结账";
$_LANG['paypalCommerce']['linkAccount'] = "链接新的 PayPal 账户";
$_LANG['paypalCommerce']['error']['noAccount'] = "在付款前，您必须选择一个已链接的 PayPal 帐户或链接一个新帐户";
...
$_LANG['idnLanguage']['invalidSelectionForTld'] = "为 :tld TLD 选择的 IDN 语言无效";
...
$_LANG['store']['xoviNow']['faq12ans'] = "<p>简短回答：不要将提高可见性作为 SEO 策略的目标。</p><p>长回答：可见性 <em>反映了</em>单一指标的排名质量；它不会带来更好的排名。将提高潜在客户实际用来查找与您类似的产品和服务的相关关键字的排名作为您的目标。 提高排名也会提高您的可见度。但真正重要的是您的排名。</p><p>根据经验，如果您的域的 网址排名良好</li><li>您拥有大量排名良好的索引网址</li><li>您对于搜索量较高的关键字排名较高</li></ul>";
...
$_LANG['ssl']['status']['awaitingIssuance'] = "等待发布";
$_LANG['ssl']['status']['cancelled'] = "已取消";
$_LANG['ssl']['status']['completed'] = "已完成";
$_LANG['ssl']['status']['configurationSubmitted'] = "已提交配置";
$_LANG['ssl']['status']['expired'] = "已过期";
$_LANG['ssl']['status']['reissueFailed'] = "重发失败";
$_LANG['ssl']['status']['reissuePending'] = "重新发布待处理";
$_LANG['ssl']['status']['重新发行'] = "重新发行";
$_LANG['ssl']['x500DN']['组织'] = "组织";
$_LANG['ssl']['x500DN']['organizationUnit'] = "组织单位";
$_LANG['ssl']['x500DN']['locality'] = "地点";
$_LANG['ssl']['x500DN']['country'] = "国家";
$_LANG['ssl']['x500DN']['state'] = "State";
$_LANG['ssl']['x500DN']['commonName'] = "常用名";
$_LANG['ssl']['x500DN']['domainName'] = "域名";
...
$_LANG['sitejetBuilder']['servicePage']['menuEdit'] = "使用 Sitejet Builder 编辑";
$_LANG['sitejetBuilder']['servicePage']['visitSite'] = "访问";
$_LANG['sitejetBuilder']['servicePage']['editSite'] = "使用 Sitejet Builder 编辑";
...
$_LANG['sitejetBuilder']['get']['title'] = "获取 Sitejet Builder";
$_LANG['sitejetBuilder']['upgradeTo']['title'] = "升级到 Sitejet Builder";
$_LANG['sitejetBuilder']['upsellDescription'] = "一款功能强大的拖放式网站构建器，可帮助您构建和发布网站。";
$_LANG['activateNowFor'] = "立即激活，价格为 :price";
$_LANG['upgradeToFor'] = "升级到 :package，价格为 :price";

////////// End of chinese language file.  Do not place any translation strings below this line! Rodots 傲世 WHMCS8.10.1 WHMCS-zh-CN
