...
$_ADMINLANG['credit']['cannotEditSystemGenerated'] = "您无法修改系统生成的信用记录。";
$_ADMINLANG['credit']['creditmanagement'] = "信用管理";
$_ADMINLANG['credit']['deleteq'] = "您确定要删除此信用并从客户余额中移除吗？";
$_ADMINLANG['credit']['editcredit'] = "编辑信用额度";
...
$_ADMINLANG['general']['mixpaneltrackingenabledinfo'] = "勾选以启用分析和用户活动追踪。<a href=\"https://go.whmcs.com/2401/analytics \">了解更多。</a>";
...
$_ADMINLANG['gettingStartedWizard']['company']['about']['exploringOptions'] = "我只是在探索选项。";
$_ADMINLANG['gettingStartedWizard']['company']['about']['notSellingProducts'] = "我尚未开始销售产品。";
$_ADMINLANG['gettingStartedWizard']['company']['about']['sellingNotOnline'] = "我只在线下销售产品。";
$_ADMINLANG['gettingStartedWizard']['company']['about']['sellingWithDifferentSystem'] = "我在其他系统中进行销售。";
$_ADMINLANG['gettingStartedWizard']['description']['analytics'] = "帮助我们让 WHMCS 变得更好。";
$_ADMINLANG['gettingStartedWizard']['description']['checkPayment'] = "使用我们的邮寄支票支付网关来记录支票和其他实物付款。";
$_ADMINLANG['gettingStartedWizard']['description']['companyLogo'] = "您的公司标志将显示在发票、电子邮件以及客户区域中。";
$_ADMINLANG['gettingStartedWizard']['description']['connectionError'] = "请检查您的服务器信息并重试。";
$_ADMINLANG['gettingStartedWizard']['description']['controlPanel'] = "选择您的网页托管控制面板。";
$_ADMINLANG['gettingStartedWizard']['description']['domains'] = "连接至少一个域名注册商以开始销售域名。";
$_ADMINLANG['gettingStartedWizard']['description']['marketConnect'] = "转售来自领先服务提供商的高质量产品和附加组件。";
$_ADMINLANG['gettingStartedWizard']['description']['paymentDeactivationProhibited'] = "您不能在入门向导中停用此模块。要停用支付网关，请前往 <strong>配置 (:wrenchIcon) > 系统设置 > 支付网关</strong>。";
$_ADMINLANG['gettingStartedWizard']['description']['paypal'] = "通过 PayPal® 实现一键支付。";
$_ADMINLANG['gettingStartedWizard']['description']['primaryIp'] = "欢迎邮件将显示此地址。";
$_ADMINLANG['gettingStartedWizard']['description']['registrarConnect'] = "已有账户？";
$_ADMINLANG['gettingStartedWizard']['description']['serverDetails'] = "您可以在设置后修改服务器配置。";
$_ADMINLANG['gettingStartedWizard']['description']['serverName'] = "输入一个名称以标识该服务器。";
$_ADMINLANG['gettingStartedWizard']['description']['firstServerConnected'] = "您已成功连接服务器。请前往 <strong>配置 (:wrenchIcon) > 系统设置 > 服务器</strong> 编辑您的服务器配置。";
$_ADMINLANG['gettingStartedWizard']['description']['setupComplete'] = "如需再次查看这些步骤，请前往 <strong>配置 (:wrenchIcon) > 入门向导</strong>。";
$_ADMINLANG['gettingStartedWizard']['description']['stripe'] = "通过 Stripe™ 实现一键支付。";
$_ADMINLANG['gettingStartedWizard']['description']['stripePublishableKey'] = "您的可发布 API 密钥用于在通信期间识别您的网站到 Stripe。";
$_ADMINLANG['gettingStartedWizard']['description']['stripeSecretKey'] = "您的密钥确保只有来自 Stripe 的通信才能被验证。";
$_ADMINLANG['gettingStartedWizard']['description']['suggestedPrices'] = "使用建议零售价或在下方自定义价格。";
$_ADMINLANG['gettingStartedWizard']['description']['tldToSell'] = "您可在完成设置后在“域名定价”配置中添加更多 TLD。";
$_ADMINLANG['gettingStartedWizard']['description']['tlds'] = "选择要销售的顶级域名 (TLD)。您可在完成设置后在“域名定价”配置中添加更多 TLD。";
$_ADMINLANG['gettingStartedWizard']['description']['tracking'] = "我们使用 <a href=\"https://go.whmcs.com/2397/mixpanel \" target=\"_blank\">Mixpanel®</a> 来追踪用户统计数据，例如您点击不同功能的频率。勾选此框表示您同意我们在与您互动期间收集此类数据。";
$_ADMINLANG['gettingStartedWizard']['description']['uploadFile'] = "上传 JPG 或 PNG 文件（最大大小：20MB）。";
$_ADMINLANG['gettingStartedWizard']['description']['wireTransfers'] = "使用我们的银行转账支付网关接受电汇付款。";
$_ADMINLANG['gettingStartedWizard']['domains']['countryBased'] = "基于国家的 (ccTLD)";
$_ADMINLANG['gettingStartedWizard']['domains']['enomBadPasswordMessage'] = "Enom 要求 API 密码包含至少一个小写字母 (a–z)、一个大写字母 (A–Z)、一个数字 (0–9) 和以下特殊字符之一：@ * - _ . /";
$_ADMINLANG['gettingStartedWizard']['domains']['enomIpNotPermitted'] = "您必须授权您的 IP 地址才能使用此 API。您的 IP 地址是 :ip。<a class='underline' target='_blank' href='https://go.whmcs.com/1885/enom #activation'>了解更多</a>。";
$_ADMINLANG['gettingStartedWizard']['domains']['featured'] = "推荐 (gTLD)";
$_ADMINLANG['gettingStartedWizard']['domains']['popular'] = "热门";
...
$_ADMINLANG['gettingStartedWizard']['extra']['centralNic'] = "销售诸如 <b>.store</b>, <b>.online</b>, <b>.es</b>, <b>.co.uk</b>, 或 <b>.eu</b> 这类域名扩展。";
$_ADMINLANG['gettingStartedWizard']['extra']['enom'] = "销售诸如 <b>.com</b>, <b>.net</b>, <b>.biz</b>, 或 <b>.info</b> 这类域名扩展。";
$_ADMINLANG['gettingStartedWizard']['extra']['paypal'] = "PayPal 可能使您的转化率提高<b>多达 66%。</b>";
$_ADMINLANG['gettingStartedWizard']['fileUpload']['noFile'] = "未选择文件。";
$_ADMINLANG['gettingStartedWizard']['fileUpload']['uploadFile'] = "上传文件";
$_ADMINLANG['gettingStartedWizard']['group']['analytics'] = "分析统计";
...
$_ADMINLANG['gettingStartedWizard']['group']['logIntoMarketConnect'] = "登录您的 WHMCS Marketplace 账户。";
$_ADMINLANG['gettingStartedWizard']['group']['marketConnect'] = "WHMCS MarketConnect";
$_ADMINLANG['gettingStartedWizard']['group']['payments'] = "设置支付方式";
$_ADMINLANG['gettingStartedWizard']['label']['accountNumber'] = "账户号码";
$_ADMINLANG['gettingStartedWizard']['label']['address'] = "街道地址";
$_ADMINLANG['gettingStartedWizard']['label']['address2'] = "街道地址 2";
$_ADMINLANG['gettingStartedWizard']['label']['allowTracking'] = "允许第三方跟踪";
$_ADMINLANG['gettingStartedWizard']['label']['bankRoutingNumber'] = "银行路由号码";
$_ADMINLANG['gettingStartedWizard']['label']['centralNic'] = "创建 CentralNic 转售商账户";
$_ADMINLANG['gettingStartedWizard']['label']['checkPayment'] = "支票付款";
...
$_ADMINLANG['gettingStartedWizard']['label']['companySize'] = "您的公司有多少员工？";
$_ADMINLANG['gettingStartedWizard']['label']['connectedEnom'] = "Enom 账户连接成功。";
$_ADMINLANG['gettingStartedWizard']['label']['copyRight'] = "版权所有 &copy; WHMCS :year";
$_ADMINLANG['gettingStartedWizard']['label']['country'] = "国家";
$_ADMINLANG['gettingStartedWizard']['label']['createNewAccount'] = "创建新账户";
$_ADMINLANG['gettingStartedWizard']['label']['currentRevenue'] = "您当前的年收入（美元）是多少？";
$_ADMINLANG['gettingStartedWizard']['label']['dashboard'] = "进入管理员仪表板";
$_ADMINLANG['gettingStartedWizard']['label']['dontShowAgain'] = "不再显示此提示。";
$_ADMINLANG['gettingStartedWizard']['label']['email'] = "电子邮件地址";
$_ADMINLANG['gettingStartedWizard']['label']['enom'] = "创建 Enom 账户";
$_ADMINLANG['gettingStartedWizard']['label']['exclusivePricing'] = "获取精选 TLD 的独家定价：";
$_ADMINLANG['gettingStartedWizard']['label']['firstName'] = "名字";
...
$_ADMINLANG['gettingStartedWizard']['label']['hostnameIp'] = "主机名或 IP 地址";
$_ADMINLANG['gettingStartedWizard']['label']['lastName'] = "姓氏";
$_ADMINLANG['gettingStartedWizard']['label']['learnMore'] = "了解更多。";
$_ADMINLANG['gettingStartedWizard']['label']['logInHere'] = "在此登录。";
$_ADMINLANG['gettingStartedWizard']['label']['logOut'] = "退出登录";
$_ADMINLANG['gettingStartedWizard']['label']['login'] = "登录";
$_ADMINLANG['gettingStartedWizard']['label']['loginNotice'] = "当您登录或注册时，即表示您同意我们的 :privacyPolicy 和 :termsAndConditions。";
$_ADMINLANG['gettingStartedWizard']['label']['marketConnectFromVendor'] = "来自 :vendorName";
$_ADMINLANG['gettingStartedWizard']['label']['minusMarkdown'] = "- :markdown 折扣";
$_ADMINLANG['gettingStartedWizard']['label']['name'] = "您的姓名";
$_ADMINLANG['gettingStartedWizard']['label']['nameOnAccount'] = "账户上的姓名";
$_ADMINLANG['gettingStartedWizard']['label']['password'] = "密码";
$_ADMINLANG['gettingStartedWizard']['label']['paypal'] = "PayPal 支付";
$_ADMINLANG['gettingStartedWizard']['label']['phoneNumber'] = "电话号码";
$_ADMINLANG['gettingStartedWizard']['label']['plusMarkup'] = "+ :markup 加价";
$_ADMINLANG['gettingStartedWizard']['label']['primaryIp'] = "主 IP 地址";
$_ADMINLANG['gettingStartedWizard']['label']['primaryNameserver'] = "主域名服务器";
$_ADMINLANG['gettingStartedWizard']['label']['privacyPolicy'] = "隐私政策";
$_ADMINLANG['gettingStartedWizard']['label']['readyToSell'] = "您是否已经开始销售产品？";
$_ADMINLANG['gettingStartedWizard']['label']['secondaryNameserver'] = "辅助域名服务器";
$_ADMINLANG['gettingStartedWizard']['label']['securityAnswer'] = "安全答案";
$_ADMINLANG['gettingStartedWizard']['label']['securityQuestion'] = "安全问题";
$_ADMINLANG['gettingStartedWizard']['label']['selectedTld'] = ":selected / :totalTlds 已选";
$_ADMINLANG['gettingStartedWizard']['label']['serverName'] = "服务器名称";
$_ADMINLANG['gettingStartedWizard']['label']['setUp'] = "我们将为您设置好。";
$_ADMINLANG['gettingStartedWizard']['label']['setupComplete'] = "初始设置步骤已完成！";
$_ADMINLANG['gettingStartedWizard']['label']['signUp'] = "注册";
$_ADMINLANG['gettingStartedWizard']['label']['state'] = "州/省";
$_ADMINLANG['gettingStartedWizard']['label']['step'] = "步骤 :step / :maxSteps";
$_ADMINLANG['gettingStartedWizard']['label']['stripe'] = "Stripe";
$_ADMINLANG['gettingStartedWizard']['label']['stripePublishableKey'] = "Stripe 可发布 API 密钥";
$_ADMINLANG['gettingStartedWizard']['label']['stripeSecretKey'] = "Stripe 私有 API 密钥";
$_ADMINLANG['gettingStartedWizard']['label']['termsAndConditions'] = "条款与条件";
...
$_ADMINLANG['gettingStartedWizard']['label']['wireTransfers'] = "电汇转账";
$_ADMINLANG['gettingStartedWizard']['label']['yourPrice'] = "您的价格";
$_ADMINLANG['gettingStartedWizard']['label']['zipCode'] = "邮编";
$_ADMINLANG['gettingStartedWizard']['marketConnectInvalidCredentials'] = "登录失败，请检查您的凭据并重试。";
$_ADMINLANG['gettingStartedWizard']['pageDescription']['centralNic'] = "创建 CentralNic 注册局账户，以获得 WHMCS 用户专属的精选 TLD 定价。";
$_ADMINLANG['gettingStartedWizard']['pageDescription']['enom'] = "立即创建 Enom 账户。";
$_ADMINLANG['gettingStartedWizard']['pageDescription']['registrar'] = "连接至少一个域名注册商以开始销售域名。";
$_ADMINLANG['gettingStartedWizard']['pageDescription']['wireTransfers'] = "请输入接收电汇转账的银行账户详细信息。";
$_ADMINLANG['gettingStartedWizard']['pageDescription']['checkPayment'] = "请输入将在发票上显示的付款地址。";
$_ADMINLANG['gettingStartedWizard']['payments']['gatewayError'] = "支付网关模块遇到意外错误。";
...
$_ADMINLANG['gettingStartedWizard']['placeholder']['bankRoutingNumber'] = "请输入您的银行路由号码。";
$_ADMINLANG['gettingStartedWizard']['placeholder']['city'] = "请输入您的城市。";
$_ADMINLANG['gettingStartedWizard']['placeholder']['companyEmail'] = "请输入公司的主要电子邮件地址。";
$_ADMINLANG['gettingStartedWizard']['placeholder']['companyName'] = "请输入您的公司名称。";
$_ADMINLANG['gettingStartedWizard']['placeholder']['country'] = "搜索或选择您的国家。";
$_ADMINLANG['gettingStartedWizard']['placeholder']['email'] = "请输入您的电子邮件地址。";
$_ADMINLANG['gettingStartedWizard']['placeholder']['enterAnswer'] = "请输入一个答案。";
...
$_ADMINLANG['gettingStartedWizard']['placeholder']['nameOnAccount'] = "请输入您银行账户上的姓名。";
...
$_ADMINLANG['gettingStartedWizard']['placeholder']['state'] = "请选择州/省。";
$_ADMINLANG['gettingStartedWizard']['placeholder']['username'] = "请输入用户名。";
$_ADMINLANG['gettingStartedWizard']['placeholder']['zipCode'] = "请输入邮政编码。";
$_ADMINLANG['gettingStartedWizard']['servers']['connectionErrorMessage'] = "请检查您的登录凭据。";
$_ADMINLANG['gettingStartedWizard']['title']['aboutCompany'] = "帮助我们为您定制体验。";
$_ADMINLANG['gettingStartedWizard']['title']['analytics'] = "您的隐私对我们非常重要。";
$_ADMINLANG['gettingStartedWizard']['title']['centralNic'] = "创建 CentralNic 注册局转售商账户";
$_ADMINLANG['gettingStartedWizard']['title']['centralNicModal'] = "登录 CentralNic 注册局";
$_ADMINLANG['gettingStartedWizard']['title']['company'] = "告诉我们关于您的公司信息。";
$_ADMINLANG['gettingStartedWizard']['title']['companyAddress'] = "设置您的业务地址";
...
$_ADMINLANG['gettingStartedWizard']['title']['domainRegistrar'] = "选择您注册域名的方式。";
$_ADMINLANG['gettingStartedWizard']['title']['domains'] = "选择要销售的域名。";
$_ADMINLANG['gettingStartedWizard']['title']['enom'] = "创建 Enom 账户。";
$_ADMINLANG['gettingStartedWizard']['title']['enomModal'] = "登录 Enom";
...
$_ADMINLANG['gettingStartedWizard']['title']['marketConnect'] = "通过 MarketConnect 提升销售额。";
$_ADMINLANG['gettingStartedWizard']['title']['offlinePayments'] = "选择您希望设置的离线付款方式：";
$_ADMINLANG['gettingStartedWizard']['title']['onlinePayments'] = "将您的在线支付处理器连接到 WHMCS：";
...
$_ADMINLANG['gettingStartedWizard']['title']['setPricing'] = "设置您的 TLD 定价。";
$_ADMINLANG['gettingStartedWizard']['title']['setupComplete'] = "设置完成。";
$_ADMINLANG['gettingStartedWizard']['title']['tld'] = "TLD";
$_ADMINLANG['gettingStartedWizard']['title']['tldToSell'] = "选择要销售的顶级域名 (TLD)。";
$_ADMINLANG['gettingStartedWizard']['title']['wireTransfers'] = "设置电汇转账。";
$_ADMINLANG['gettingStartedWizard']['title']['checkPayment'] = "设置邮寄支票付款。";
$_ADMINLANG['gettingStartedWizard']['title']['yourCost'] = "您的成本";
...
$_ADMINLANG['marketConnect']['socialbee']['about']['author'] = "- Ovi Negrean，SocialBee 首席执行官";
$_ADMINLANG['marketConnect']['socialbee']['about']['p1'] = "SocialBee 是一款一体化社交媒体管理工具，使用户能够从一个平台分享内容至多个社交媒体网络。您可以设定发布计划、分享内容、分析表现，并与关注者互动。";
$_ADMINLANG['marketConnect']['socialbee']['about']['p2'] = "SocialBee 成立于简化各种规模企业的社交媒体管理。自 2016 年推出以来，该平台已发展成一个强大的工具，使用户能够在一个地方创建、安排、分析和参与跨平台内容——所有操作都集中在一个界面中。凭借以用户友好设计为重点和强大功能，如分类调度和分析，SocialBee 被企业家、市场营销人员和代理商信赖，以优化其社交媒体形象并与其受众建立有意义的联系。";
$_ADMINLANG['marketConnect']['socialbee']['about']['quote'] = "\"在 SocialBee，我们的使命是帮助企业在不更换多个工具的情况下在社交媒体上取得成功。受全球数千用户的信任，我们结合强大功能与以客户为中心的方法，确保您的成功。无论您是刚开始还是管理大量社交媒体账户，SocialBee 都会在每一步为您提供帮助。\"";
$_ADMINLANG['marketConnect']['socialbee']['about']['title'] = "关于我们";
$_ADMINLANG['marketConnect']['socialbee']['faq']['h1'] = "SocialBee 可以管理哪些社交媒体平台？";
$_ADMINLANG['marketConnect']['socialbee']['faq']['h2'] = "SocialBee 用户有哪些支持选项？";
$_ADMINLANG['marketConnect']['socialbee']['faq']['h3'] = "SocialBee 的代理计划与普通 Pro 计划有何不同？";
$_ADMINLANG['marketConnect']['socialbee']['faq']['h4'] = "SocialBee 的服务器位于哪里？SocialBee 的数据存储在哪里？";
$_ADMINLANG['marketConnect']['socialbee']['faq']['h5'] = "为什么我要销售社交媒体管理工具？";
$_ADMINLANG['marketConnect']['socialbee']['faq']['h6'] = "企业会为社交媒体工具付费吗？";
$_ADMINLANG['marketConnect']['socialbee']['faq']['q1'] = "您可以管理和安排流行平台的内容，如 Facebook、Instagram、Threads、X™（前 Twitter™）、LinkedIn、Pinterest、Google Business Profile™、TikTok、YouTube™ 和 Bluesky。";
$_ADMINLANG['marketConnect']['socialbee']['faq']['q2'] = "用户可以通过聊天、<a href=\"mailto:hello@socialbee.com\">电子邮件</a>、<a href=\"https://socialbee.com/calendar \">电话</a> 和一个包含丰富资源的 <a href=\"https://help.socialbee.com \">知识库</a> 获取 SocialBee 的帮助。";
$_ADMINLANG['marketConnect']['socialbee']['faq']['q3'] = "代理计划（Pro50、Pro100 和 Pro150）与 Pro 计划的功能相同。主要区别在于您可以连接的社交媒体资料数量、工作区数量以及可以添加到每个工作区的用户数：";
$_ADMINLANG['marketConnect']['socialbee']['faq']['q4'] = "SocialBee 的服务器位于欧洲爱尔兰。";
$_ADMINLANG['marketConnect']['socialbee']['faq']['q5'] = "销售像 SocialBee 这样的社交媒体管理工具可以让您抓住社交媒体营销解决方案日益增长的需求。中小型企业在社交媒体上维护形象、节省时间并增加互动方面都需要工具——这为像您这样的经销商创造了强劲的市场。";
$_ADMINLANG['marketConnect']['socialbee']['faq']['q6'] = "是的，中小型企业正在迅速投资社交媒体工具来管理他们的社交媒体形象。作为最重要的营销渠道之一，社交媒体有助于企业发展，而企业也愿意投资可靠的工具来帮助他们实现目标。";
$_ADMINLANG['marketConnect']['socialbee']['features']['f1']['p1'] = "SocialBee 与 Canva、Unsplash 和 GIPHY 集成，因此您可以轻松地为帖子创建和策划视觉内容。";
$_ADMINLANG['marketConnect']['socialbee']['features']['f1']['p2'] = "几秒钟内生成标题和图片，并访问超过 1,000 个预设提示以节省时间。";
$_ADMINLANG['marketConnect']['socialbee']['features']['f1']['p3'] = "尝试不同的帖子类型，如图片、视频、轮播图、故事和 Reels，以找到最能引起观众共鸣的内容。";
$_ADMINLANG['marketConnect']['socialbee']['features']['f1']['title'] = "创作";
$_ADMINLANG['marketConnect']['socialbee']['features']['f2']['p1'] = "从一个地方安排主要平台如 Facebook®、Instagram、LinkedIn®、TikTok、Pinterest 等的帖子。";
$_ADMINLANG['marketConnect']['socialbee']['features']['f2']['p2'] = "使用可视化日历组织您的帖子，一览整个社交媒体策略。";
$_ADMINLANG['marketConnect']['socialbee']['features']['f2']['p3'] = "提前计划和排队帖子，无需手动发帖即可保持社交媒体账号活跃。";
$_ADMINLANG['marketConnect']['socialbee']['features']['f2']['title'] = "安排";
$_ADMINLANG['marketConnect']['socialbee']['features']['f3']['p1'] = "从一个易于管理的收件箱中回复所有社交媒体平台上的评论、提及和私信。";
$_ADMINLANG['marketConnect']['socialbee']['features']['f3']['p2'] = "无需切换不同社交媒体账户即可节省时间并随时跟进对话。";
$_ADMINLANG['marketConnect']['socialbee']['features']['f3']['p3'] = "每当有人与您的内容互动时都会收到通知，这样您就不会错过重要消息或互动机会。";
$_ADMINLANG['marketConnect']['socialbee']['features']['f3']['title'] = "互动";
$_ADMINLANG['marketConnect']['socialbee']['features']['f4']['p1'] = "直接在内容草稿上分享反馈并标记同事。";
$_ADMINLANG['marketConnect']['socialbee']['features']['f4']['p2'] = "通过独立且有序的工作空间管理多个品牌或客户。";
$_ADMINLANG['marketConnect']['socialbee']['features']['f4']['p3'] = "通过共享协作空间避免重复工作。";
$_ADMINLANG['marketConnect']['socialbee']['features']['f4']['title'] = "协作";
$_ADMINLANG['marketConnect']['socialbee']['features']['f5']['p1'] = "通过易懂的指标、图表、地图等清晰了解您的社交媒体进展。";
$_ADMINLANG['marketConnect']['socialbee']['features']['f5']['p2'] = "比较平台表现以确定哪里的努力回报最大。";
$_ADMINLANG['marketConnect']['socialbee']['features']['f5']['p3'] = "长期跟踪所有社交媒体账户的互动、曝光量、点击率和粉丝增长情况。";
$_ADMINLANG['marketConnect']['socialbee']['features']['f5']['title'] = "分析";
$_ADMINLANG['marketConnect']['socialbee']['learn']['tab']['about'] = "关于";
$_ADMINLANG['marketConnect']['socialbee']['learn']['tab']['faq'] = "常见问题";
$_ADMINLANG['marketConnect']['socialbee']['learn']['tab']['features'] = "功能";
$_ADMINLANG['marketConnect']['socialbee']['learn']['tab']['lite'] = "Lite 计划";
$_ADMINLANG['marketConnect']['socialbee']['learn']['tab']['pricing'] = "定价";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['2years'] = "最多 2 年";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['3months'] = "最多 3 个月";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['AICreation'] = "AI 内容创作";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['GIPHY'] = "GIPHY 集成";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['RRP'] = ":price RRP";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['URL'] = "短链接集成";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['accounts'] = "社交媒体账户";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['addons'] = "用户、工作区<br>和档案的附加功能";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['automationTool'] = "自动化工具集成";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['browserExtension'] = "浏览器插件";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['canva'] = "Canva 集成";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['categories'] = "内容分类<br>(文件夹)";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['comparePlans'] = "对比计划";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['comparePrices'] = "对比价格";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['contentApproval'] = "内容审批";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['contentCuration'] = "内容策展";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['contentCurator'] = "内容策展人集成";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['contentResharing'] = "内容重新分享";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['contentSchedulingPublishing'] = "内容排期<br>和发布";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['dataAccess'] = "历史<br>数据访问";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['exportBrandedReports'] = "导出品牌报告";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['importFeeds'] = "导入 RSS 源";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['internalNotes'] = "内部备注<br>(反馈)";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['mobileApp'] = "移动应用";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['postDrafts'] = "帖子草稿";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['postingTimeSuggestions'] = "最佳发布时间建议";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['posts'] = "每分类帖子数";
...
$_ADMINLANG['marketConnect']['socialbee']['pricing']['tagBootstrap'] = "启动";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['tagPro'] = "专业版";
...
$_ADMINLANG['marketConnect']['socialbee']['pricing']['unsplash'] = "Unsplash 集成";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['users'] = "用户";
$_ADMINLANG['marketConnect']['socialbee']['pricing']['workspaces'] = "专用工作区";
$_ADMINLANG['marketConnect']['socialbee']['profiles'] = ":num 社交档案";
$_ADMINLANG['marketConnect']['socialbee']['workspaces'] = ":num 工作区";
$_ADMINLANG['marketConnect']['socialbee']['workspaceusers'] = ":num 每个工作区用户";
...
$_ADMINLANG['support']['ticket']['action']['customFieldValueUpdatePlaceholder'] = "如果您不输入值，计划操作将会把自定义字段更新为空值。";
...
$_ADMINLANG['support']['ticket']['action']['scheduleDuplicateError'] = "系统无法保存该操作。您不能计划对同一自定义字段的多次更新。";
...
$_ADMINLANG['support']['ticket']['action']['skip']['any_reply'] = "在工单更新后取消计划";
$_ADMINLANG['support']['ticket']['action']['skip']['no_skip'] = "在工单更新后不要取消计划";
$_ADMINLANG['support']['ticket']['action']['skip']['nonadmin_reply'] = "在非管理员工单更新后取消计划";
...
$_ADMINLANG['taxconfig']['vat']['modeUK']['description'] = "选择一种用于验证英国增值税号的方法。";
$_ADMINLANG['taxconfig']['vat']['modeUK']['label'] = "英国增值税验证模式";
$_ADMINLANG['taxconfig']['vat']['provider']['VIES']['name'] = "VIES";
$_ADMINLANG['taxconfig']['vat']['provider']['WhmcsVatService']['name'] = "远程验证";
$_ADMINLANG['taxconfig']['vat']['provider']['acceptAll']['name'] = "接受所有增值税号";
$_ADMINLANG['taxconfig']['vat']['provider']['acceptAllToDo']['name'] = "接受所有增值税号并创建待办事项";
...
$_ADMINLANG['whois']['invalidtld'] = "您无法对 %s TLD 执行 WHOIS 查询。";
...
$_ADMINLANG['wizard']['mixpanelBannerLabel'] = "我们使用 <strong><a href=\"https://go.whmcs.com/2397/mixpanel \" target=\"_blank\">Mixpanel®</a></strong> 来追踪用户活动，例如您点击不同功能的频率。通过启用此功能，您将帮助我们通过真实用户交互改进 WHMCS。";
