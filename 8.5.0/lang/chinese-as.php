...
$_LANG['store']['addon']['wptk']['pleskIntroTitle'] = "Smart Updates for WordPress Toolkit 识别并分析您的 WordPress 安装的任何潜在更新，然后在对您的实时网站无风险的情况下执行更新或通知您现在有潜在危险的更新可用。";
...
$_LANG['store']['addon']['wptk']['plesk']['featureBody3'] = "默认强化您的网站，通过 Toolkit 的安全扫描程序进一步增强。无需安全专业知识。";
$_LANG['store']['addon']['wptk']['plesk']['featureTitle4'] = "运行和自动化";
$_LANG['store']['addon']['wptk']['plesk']['featureBody4'] = "单独或批量执行 WP 核心、主题或插件的更新。监控和运行所有 WordPress一个仪表板中的站点。";
...
$_LANG['marketConnect']['cPanelSEO']['manage'] = '登录cPanel SEO';
$_LANG['store']['cPanelSEO']['title'] = 'cPanel SEO';
$_LANG['store']['cPanelSEO']['tagline'] = '通过 :lineBreak cPanel SEO 在线查找';
$_LANG['store']['cPanelSEO']['getStarted'] = '开始';
$_LANG['store']['cPanelSEO']['productTourTitle'] = '产品之旅';
$_LANG['store']['cPanelSEO']['measureResultsTitle'] = "触手可及的测量结果";
$_LANG['store']['cPanelSEO']['measureResults1'] = "假设您想在明年发展您的业务。您可以先在 SEO 机构投资一些钱，但这似乎是压倒性的 没有技术技能的人的任务！";
$_LANG['store']['cPanelSEO']['measureResults2'] = ":startBold 幸运的是，有一个更简单的方法 :endBold: 让我们确保人们从他们使用 cPanel 的在线搜索中找出是什么让您的公司变得如此出色 搜索引擎优化。";
...
$_LANG['store']['cPanelSEO']['features']['siteAudit']['title'] = '网站审核';
$_LANG['store']['cPanelSEO']['features']['textOptimizer']['title'] = '文本优化器';
$_LANG['store']['cPanelSEO']['features']['benchmarking']['title'] = 'Benchmarking';
$_LANG['store']['cPanelSEO']['features']['keywords']['line1'] = "用于研究和灵感的 53M+ 关键字数据库";
$_LANG['store']['cPanelSEO']['features']['keywords']['bullet1'] = "获取全面的关键字数据";
$_LANG['store']['cPanelSEO']['features']['keywords']['bullet2'] = "找出您网站的排名关键字";
$_LANG['store']['cPanelSEO']['features']['keywords']['bullet3'] = "识别有前景的关键字以获得更好的流量";
$_LANG['store']['cPanelSEO']['features']['keywords']['bullet4'] = "分析你的竞争对手的关键词和排名";
$_LANG['store']['cPanelSEO']['features']['keywords']['bullet5'] = "比较国际市场";
$_LANG['store']['cPanelSEO']['features']['keywords']['bullet6'] = "从 53M+ 关键字数据库中获利";
$_LANG['store']['cPanelSEO']['features']['advisor']['line1'] = "接收、管理和解决任务以改进您的网站";
$_LANG['store']['cPanelSEO']['features']['advisor']['bullet1'] = "看板式任务管理器";
$_LANG['store']['cPanelSEO']['features']['advisor']['bullet2'] = "自定义和优先任务";
$_LANG['store']['cPanelSEO']['features']['advisor']['bullet3'] = "详细说明和附加信息";
$_LANG['store']['cPanelSEO']['features']['advisor']['bullet4'] = "无需专业知识";
$_LANG['store']['cPanelSEO']['features']['advisor']['bullet5'] = "每周更新";
$_LANG['store']['cPanelSEO']['features']['rankTracker']['line1'] = "监控您和竞争对手的排名";
$_LANG['store']['cPanelSEO']['features']['rankTracker']['bullet1'] = "每周或每天跟踪基本排名";
$_LANG['store']['cPanelSEO']['features']['rankTracker']['bullet2'] = "实体企业的本地排名";
$_LANG['store']['cPanelSEO']['features']['rankTracker']['bullet3'] = "全球公司的国际排名";
$_LANG['store']['cPanelSEO']['features']['rankTracker']['bullet4'] = "关注你的竞争对手";
$_LANG['store']['cPanelSEO']['features']['rankTracker']['bullet5'] = "跟踪关键字排名或专用页面";
$_LANG['store']['cPanelSEO']['features']['siteAudit']['line1'] = "检查您网站的技术基础";
$_LANG['store']['cPanelSEO']['features']['siteAudit']['bullet1'] = "自动化的每周站点审核";
$_LANG['store']['cPanelSEO']['features']['siteAudit']['bullet2'] = "技术网站检查";
$_LANG['store']['cPanelSEO']['features']['siteAudit']['bullet3'] = "优先结果";
$_LANG['store']['cPanelSEO']['features']['siteAudit']['bullet4'] = "显示改进";
$_LANG['store']['cPanelSEO']['features']['siteAudit']['bullet5'] = "翻译结果到顾问任务";
$_LANG['store']['cPanelSEO']['features']['textOptimizer']['line1'] = "通过数据驱动的内容优化提高您的排名";
$_LANG['store']['cPanelSEO']['features']['textOptimizer']['bullet1'] = "将您的文本与亚马逊和谷歌的前 10 个结果进行比较";
$_LANG['store']['cPanelSEO']['features']['textOptimizer']['bullet2'] = "引导式提高内容质量";
$_LANG['store']['cPanelSEO']['features']['textOptimizer']['bullet3'] = "按照指示添加、增加或减少关键字";
$_LANG['store']['cPanelSEO']['features']['benchmarking']['line1'] = "分析竞争对手，比较性能并提高您的 SEO";
$_LANG['store']['cPanelSEO']['features']['benchmarking']['bullet1'] = "发现具有相同关键字排名的域";
$_LANG['store']['cPanelSEO']['features']['benchmarking']['bullet2'] = "确定你的利基市场的领导者";
$_LANG['store']['cPanelSEO']['features']['benchmarking']['bullet3'] = "比较两个或多个域的关键字排名";
$_LANG['store']['cPanelSEO']['features']['benchmarking']['bullet4'] = "跟踪和比较您的竞争对手在重要关键字上的排名";
$_LANG['store']['cPanelSEO']['features']['benchmarking']['bullet5'] = "跟踪和比较可见性分数";
$_LANG['store']['cPanelSEO']['audience']['freelancersTitle'] = "自由职业者";
$_LANG['store']['cPanelSEO']['audience']['freelancersDesc'] = "cPanel SEO 旨在为您的个人网站或客户的网站提供即时价值，从最初的网站审核到推荐改善您的搜索引擎结果。";
$_LANG['store']['cPanelSEO']['audience']['smbizTitle'] = "中小企业";
$_LANG['store']['cPanelSEO']['audience']['smbizDesc'] = "您不必成为 SEO 专家来提高您的业务的 Google 排名。cPanel SEO 将为您确定最佳关键字业务，同时还要关注竞争对手的表现。";
$_LANG['store']['cPanelSEO']['moneyBackGuarantee'] = "灵活的定价选项：guaranteeStart 30 天退款保证：guaranteeEnd";
$_LANG['store']['cPanelSEO']['featurematrix']['1'] = "项目";
$_LANG['store']['cPanelSEO']['featurematrix']['2'] = "完全访问帐户";
$_LANG['store']['cPanelSEO']['featurematrix']['3'] = "只读账户";
$_LANG['store']['cPanelSEO']['featurematrix']['4'] = "竞争对手基准测试";
$_LANG['store']['cPanelSEO']['featurematrix']['5'] = "每个项目的竞争对手";
$_LANG['store']['cPanelSEO']['featurematrix']['6'] = "关键词研究";
$_LANG['store']['cPanelSEO']['featurematrix']['7'] = "Rank Tracker";
$_LANG['store']['cPanelSEO']['featurematrix']['8'] = "关键字抓取";
$_LANG['store']['cPanelSEO']['featurematrix']['9'] = "关键字检查";
$_LANG['store']['cPanelSEO']['featurematrix']['10'] = "站点审核";
$_LANG['store']['cPanelSEO']['featurematrix']['11'] = "要抓取的页面";
$_LANG['store']['cPanelSEO']['featurematrix']['12'] = "SEO 顾问";
$_LANG['store']['cPanelSEO']['featurematrix']['13'] = "SEO 文本优化器";
$_LANG['store']['cPanelSEO']['faqTitle'] = "常见问题";
$_LANG['store']['cPanelSEO']['faq1'] = "什么是 SEO？";
$_LANG['store']['cPanelSEO']['faq1ans'] = "<p>SEO 是 Search Engine Optimization 的首字母缩写词。它是一种重要的在线营销策略，致力于将潜在客户吸引到您的网站。它的目标是优化网站以使所选关键字在搜索引擎上获得最高位置。这一目标是通过战略性地采取措施改进网站的技术设置和内容以及从其他域获取反向链接来实现的。</p><p>SEO分为三个一般类别：</p><ol><li>关键词和排名</li><li>站内搜索引擎优化</li><li>站外搜索引擎优化</li></ol><p>搜索引擎优化专家应用措施来满足搜索引擎对每个类别的排名因素。搜索引擎使用排名因素来确定它在搜索结果中列出网站的位置。</p>";
$_LANG['store']['cPanelSEO']['faq2'] = "我为什么需要 SEO？";
$_LANG['store']['cPanelSEO']['faq2ans'] = "<p>每天，数百万人使用搜索引擎查找生活各个方面的信息或服务：食谱、指南、产品、航班、导航、门票、娱乐等。大多数人使用搜索引擎浏览网络，以找到问题的答案和挑战的解决方案。</p><p>一项研究表明，68% 的网络流量来自搜索引擎. 53% 的流量来源于自然搜索——不是广告的搜索结果（付费搜索），可以通过 SEO 改进。</p><img src=\":image1\"><p>在换句话说，自然搜索 (SEO) 和付费搜索（SEA，搜索结果中的广告）占据了网络流量的最大份额。</p><p>即使我们下线的地方也受到搜索引擎的显着影响：我们使用 Google 和 Apple 地图和本地搜索结果来查找地点和附近的服务，如美发店、超市、餐馆和医生。我们根据在线评论选择目的地。然后我们指示基于搜索引擎的服务引导我们到达那里，无论是开车、乘坐公共交通工具还是步行。</p><p>现在，想象一下，如果您的业务、产品和服务未在搜索结果中列出。想象一下，人们无法在网上找到您购买您的产品或找到进入您的实体店的方式。相反，他们很可能会选择你的竞争对手。</p>";
$_LANG['store']['cPanelSEO']['faq3'] = "SEO 能为我做什么？";
$_LANG['store']['cPanelSEO']['faq3ans'] = "<p>在 SEO 的帮助下，用户可以在线找到您的业务、产品和服务——并购买它们。如上所述，这意味着人们可以在线找到您，也可以更轻松地离线找到您。</p><p>SEO 最大限度地提高了您在对您的业务至关重要的关键字中排名靠前的机会。您的位置越好，越多的人会找到自己的方式您的网站——通常位于搜索结果的第一页（或前十）。</p><p><strong>为什么选择第一页？</strong></p><p>问得好。研究表明31.7% 的用户点击第一个自然搜索结果（排名第一）；高达 75.1% 的所有点击进入前三名搜索结果。之后，点击次数随着每个后续位置迅速减少。</p>< img src=\":image2\"><p>这种行为表明用户很少看第二页或更低的结果，更不用说点击其中任何一个了。</p><img src=\":image3\"> <p>这就是为什么企业需要出现在搜索引擎的第一页结果，至少对于相关关键字而言。</p><p>简而言之：对于自由职业者和企业主来说，拥有一个网站或任何类型的在线形象至关重要，即使他们提供他们的产品或服务离线</li><li>执行 SEO 以确保他们在相关关键字的第一页排名</li></ol>";
$_LANG['store']['cPanelSEO']['faq4'] = "为什么关键词很重要？";
$_LANG['store']['cPanelSEO']['faq4ans'] = "<p><em>关键字</em>是搜索查询（词、词组、句子和问题）的技术术语。帮助，用户找到可以回答他们的问题并提供解决方案的内容。简单地说，关键字是用户与您的网站之间的链接。搜索引擎将关键字与网站进行比较，寻找相关性最高的内容。</p><p>A SEO 的很大一部分在于识别有可能为您的网站带来相关流量的关键字——换句话说，吸引潜在客户。为此，您需要识别人们在搜索优惠时使用的搜索词（或关键字）喜欢您的。这个过程称为关键字研究。理想情况下，关键字研究为您提供涵盖整个客户旅程的搜索查询的关键字列表。</p>";
$_LANG['store']['cPanelSEO']['faq5'] = "什么是关键词优化？";
$_LANG['store']['cPanelSEO']['faq5ans'] = "<p>所以我们知道相关性是搜索结果中排名靠前的关键因素。要创建相关内容，您需要处理围绕单个子页面或 URL 上的关键字的主题和问题。然后，确保您的关键字出现在您页面上的关键位置。</p><p>假设您从事冰淇淋行业。您的关键字之一是 < em>s'mores 冰淇淋三明治</em>。现在您专注于与 <em>s'mores 冰淇淋三明治有关的所有事情</em>。</p><p>您想做什么是为 <em>s'mores 冰淇淋三明治</em>创建一个食谱页面，用户可以在其中找到易于理解的食谱、图片或视频，以及他们可能遇到的问题的答案。<em>S'mores ice cream sandwich</em> 是您的焦点关键字，应该出现在您页面的 URL、标题、标题等中。</p><p>提供专门的关键字优化页面可以让搜索引擎的第二批用户轻松使用，也无法确定您的页面的全部内容。这样，t嘿可以在相关搜索结果中的好位置列出它。</p>";
$_LANG['store']['cPanelSEO']['faq6'] = "如何使用顾问";
$_LANG['store']['cPanelSEO']['faq6ans'] = "<p>首先，通过单击顶部导航栏中的顾问来查看顾问板。它是一个看板，可帮助您按状态组织任务. 您的任务按重要性进行颜色编码：</p><ul><li><strong>红色：</strong>高。尽快解决。</li><li><strong>黄色：</strong>中. 尽快解决这些问题。</li><li><strong>蓝色：</strong>低。牢记它们并尽可能解决它们。</li></ul><img src=\":image1 \"><p>您可以在完成任务时拖放，将任务分配给其他用户（取决于您的计划），并按受让人过滤。</p><p>如上所述，任务是混合每周对您的网站进行自动审核时发现的标准基本 SEO 措施和问题。</p>";
$_LANG['store']['cPanelSEO']['faq7'] = "我想要其他网站的顾问。如何获得？";
$_LANG['store']['cPanelSEO']['faq7ans'] = "<p>请记住，您确实需要一个 <em>项目</em> 才能使顾问功能正常工作。此外，大多数顾问的任务是针对项目网站（通常是您或您客户的网站）量身定制的。如果您管理多个网站，则需要为每个网站创建一个额外的项目。</p><p>添加或切换到另一个项目，单击顶部导航栏中的 <em>项目</em> 菜单。根据您的计划，您可能需要升级它以添加另一个项目。</p>";
$_LANG['store']['cPanelSEO']['faq8'] = "我如何将任务分配给其他用户？";
$_LANG['store']['cPanelSEO']['faq8ans'] = "<p>要将任务分配给其他用户，您需要一个允许其他用户的计划。如果您的计划包括其他用户，您'将在您的顾问和任务中找到受让人菜单。只需选择一个用户来分配任务或过滤顾问。要添加新用户，请单击您的个人资料头像，然后单击<em>用户</em>。如果您的计划不包括其他用户，您不会在顾问或任务中看到 <em>Assignee</em> 菜单。升级您的计划以添加用户。</p>";
$_LANG['store']['cPanelSEO']['faq9'] = "有些任务我已经介绍过了。为什么会弹出来？";
$_LANG['store']['cPanelSEO']['faq9ans'] = "<p>您可能会看到您已经解决或涵盖的任务有两个原因。如上所述，任务是基本 SEO 的混合每周对您的网站进行自动审核时发现的措施和问题。</p><p>首先，涵盖基本 SEO 措施的任务对每个人都是相同的，并不是针对您的网站或业务量身定制的。例如，我们不知道无论您是为自己的企业创建了 Google 帐户并设置了 Search Console，还是安装了 SEO 插件。如果您已经完成了工作！只需将这些任务标记为完成即可。</p><p>第二个原因是Advisor 会根据每周自动化站点审核的结果自动更新。换句话说，如果站点审核发现与您过去完成的任务有关的任何问题，它将自动更新并在“打开”部分中弹出。</p >";
$_LANG['store']['cPanelSEO']['faq10'] = "什么是项目可见性？";
$_LANG['store']['cPanelSEO']['faq10ans'] = "<p>虽然可见性是一个很好的分数，可以让你了解你的整体表现并比较网站，但它并不适合你的特定关键字集。</p><p>这就是我们提供的原因<em>Project Visibility</em>。该指标的计算方式与 Visibility 相同，但不是使用 500,000 个跨行业关键字，Project Visibility 完全基于您的 Rank Tracker 中的关键字。</p><p>在换句话说，Project Visibility 是与您的业务相关的一组独特关键字的自定义可见性分数。</p><p>您可以在此处找到 Project Visibility：<em>Projects ?Rank Tracker ?Visibility</em >.</p><p>您可能已经知道，您还可以在 Rank Tracker 中跟踪竞争对手的排名。这样，您也可以获得他们的 Project Visibility，从而获得更多信息客观比较。因此，即使他们的产品或服务组合略有不同，Project Visibility 也会专门针对您实际共享的关键字。</p>";
$_LANG['store']['cPanelSEO']['faq11'] = "为什么能见度分数有用？";
$_LANG['store']['cPanelSEO']['faq11ans'] = "<p>使用您的可见性分数作为您的整体 SEO 性能、问题和优化潜力的指标。</p><p><strong>1. 了解您的整体 SEO 表现</strong></p><p>您可以跟踪单个关键字的排名并知道您的排名。这是一件很重要的事情。但是，排名跟踪确实不是让您鸟瞰您的排名的整体提升——但可见性确实如此。当您的 SEO 措施有效并且排名提高时，您的可见性得分也会提高。</p><p><strong>2. 诊断SEO 问题</strong></p><p>您的能见度突然下降表明您的 SEO 性能存在问题。使用“能见度”作为警报。如果它显着下降，请开始挖掘发生了什么。以下是常见原因列表：</p><ul><li>您受到了 <strong>Google 处罚</strong>。请查看 Search Console 中的通知。请务必关注 <a href=\":googleWebmasterGuidelinesUrl\" target=\"_blank\">Google 的网站管理员指南</a>。</li><li>Google 算法最近发生的变化会产生一些影响。询问最近的 <strong>Google 更新</strong> 及其内容。</li><li>您的竞争对手优化了他们的网站和内容，现在他们在竞争中胜过了您。将他们的（历史）<strong>可见性</strong>与您的进行比较。使用 <a href=\":waybackMachineUrl\" target=\"_blank\">Wayback Machine</a> 比较其内容的变化。</li><li>您重新启动网站时并未考虑 SEO。例如，检查 <em>robots.txt</em> 和 <em>.htaccess</em> 是否有意外阻止的页面、增加的 404 状态代码、错误的 301 重定向和内部链接。<br><br>您以无助于排名的方式更改了您的内容。考虑撤消更改。<br><br>您的网站存在技术问题。运行<em>站点审核</em>或检查您的<strong><em>顾问</em></strong>是否有未完成的技术任务。检查您的后端是否存在可能造成严重破坏的过时、最近更新或不兼容的<strong>插件</strong>。<br><br>原因是托管问题。询问您的主机是否最近进行了更改、是否被黑客入侵、移动了他们的服务器或遇到了技术问题。查看您的服务器是否有问题。</li></ul><p>请记住，此列表并不详尽。这些原因中的一个或多个可以同时适用，也可以同时存在其他原因。</p><p><strong>3.竞争对手比较</strong></p><p>可见性是快速比较两个或多个网站的重要指标。对照他们检查你的能见度。谁在竞争谁？过去是否有竞争对手超越您，反之亦然？谁在这个领域领先，你和你最激烈的竞争对手之间的差距有多大？回答这些问题将帮助您制定 SEO 策略，以在您的利基市场中脱颖而出（并保持）。</p><p><strong>4.使用历史数据跟踪随时间推移的可见性发展</strong></p><p>想了解网站随时间推移的表现如何？我们提供的历史数据可以追溯到 2009 年，没有季节性波动。这样，您就可以跟踪和比较历史可见性，并查看它们在很长一段时间内的发展。</p>";
$_LANG['store']['cPanelSEO']['faq12'] = "我怎样才能提高我的能见度分数？";
$_LANG['store']['cPanelSEO']['faq12ans'] = "<p>简答：不要将提高可见性作为您的 SEO 策略的目标。</p><p>长答案：可见性 < em>在单一指标中反映</em>您的排名质量；它不会带来更好的排名。将提高潜在客户实际用于查找与您类似的产品和服务的相关关键字的排名作为您的目标。提高您的排名也会提高您的知名度。但真正重要的是您的排名。</p><p>根据经验，如果</p><ul><li>您的域名是URL 排名靠前</li><li>您拥有大量排名良好的索引 URL</li><li>您在搜索量高的关键字中排名靠前</li></ul>";
$_LANG['store']['cPanelSEO']['promo']['sidebar']['title'] = "SEO 工具";
$_LANG['store']['cPanelSEO']['promo']['sidebar']['body'] = "通过准确、可靠且易于使用的网站排名、关键字和顾问。";
$_LANG['store']['cPanelSEO']['cartTitle'] = "SEO 工具";
$_LANG['store']['cPanelSEO']['cartShortDescription'] = "通过准确、可靠和易于使用的网站排名、关键字和顾问来提高您的网站性能。";

////////// End of chinese language file.  Do not place any translation strings below this line! Rodots 傲世 WHMCS8.5.0 WHMCS-zh-CN
